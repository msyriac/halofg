...
if rank==0:
    ...
    np.save("beam_0.3_noise_0.5_area_4sqdeg_covmat.npy",rstats['cov'])
    np.save("beam_0.3_noise_0.5_area_4sqdeg_lbin_edges.npy",lbin_edges)
